    ...
    return (
        <Dialog.Root open={open} onOpenChange={onClose}>
            <Dialog.Portal>
                ...
                <Dialog.Content className="fixed top-1/2 left-1/2 z-50 w-[100%] max-w-[480px] h-[90vh] transform -translate-x-1/2 -translate-y-1/2 bg-black rounded-lg overflow-hidden">
