    ...
    return (
        <div className={clsx("w-full mx-auto p-4", className)}>
            <div className="grid grid-cols-2 lg:grid-cols-3 grid-rows-1 gap-y-4 lg:gap-x-4">
                ...
                >
                    <h4 className="text-lg title-font font-semibold text-white">RESPONSIBLE GAMING</h4>
                ...
                >
                    ...
                    <div className="relative z-10 flex flex-col items-center">
                        <p className='title-font mx-4 text-white text-center font-bold mb-6 lg:mb-8'>GROWING LIBRARY OF</p>
                        <p className='title-font text-[#FFD96B] text-center font-bold text-[48px] lg:text-8xl mb-6 lg:mb-8 '>HUNDREDS</p>
                        <p className='title-font text-white text-center font-bold'>OF GAMES</p>
                    </div>
                </motion.div>
                ...
                >
                    ...
                    ></div>
                    <div className="relative z-10 flex flex-col items-center">
                        <p className='title-font mx-4 text-center text-white font-bold mb-6 lg:mb-8'>SUPPORTS</p>
                        <p className='title-font text-center text-[#FFD96B] font-bold text-[48px] lg:text-8xl mb-6 lg:mb-8'>ALL</p>
                        <p className='title-font text-center text-white font-bold uppercase'>CURRENCIES & LANGUAGES</p>
                    </div>
                </motion.div>
